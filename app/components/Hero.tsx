...
export default function Hero() {
  return (
    <section className="relative min-h-[100svh] overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[70svh] max-w-6xl flex-col items-center justify-center px-4 pb-10 pt-20 text-center sm:min-h-[100svh] sm:px-6 sm:py-28">
        ...
        <p
          className="rise shine gold-metal mt-8 font-display sm:mt-12 text-6xl font-black leading-none tracking-tight sm:text-8xl lg:text-9xl"
          data-text="GOLDROCK"
        ...
        <h1
          className="rise mt-6 font-display text-2xl font-bold leading-[1.3] sm:mt-8 text-white sm:whitespace-nowrap sm:text-4xl"
        ...
        <p
          className="rise mt-5 max-w-2xl text-[15px] leading-relaxed text-white/80 sm:text-lg"
        ...
        >
          ...
          <a
            href={PHONE_HREF}
            className="inline-flex items-center gap-2 rounded-2xl border border-gold bg-black/45 px-6 py-3.5 text-[15px] font-semibold text-white shadow-[0_4px_14px_rgba(0,0,0,0.3)] backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:border-gold-soft hover:bg-black/65 sm:px-8 sm:py-4 sm:text-base"
          >

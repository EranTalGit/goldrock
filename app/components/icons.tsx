...
const paths: Record<ServiceIconName, string> = {
  ...
  broom: "M11 3.5l1.7 4.3 4.3 1.7-4.3 1.7L11 15.5 9.3 11.2 5 9.5l4.3-1.7zM18 13.5l.8 2 2 .8-2 .8-.8 2-.8-2-2-.8 2-.8zM6.5 16l.6 1.5 1.5.6-1.5.6L6.5 20l-.6-1.5L4.4 18l1.5-.6z",
  diamond: "M7 3h10l4 6-9 12L3 9l4-6zm0 0l5 6 5-6M3 9h18M12 9v12",

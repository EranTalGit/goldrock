...
export default function MobileCtaBar() {
  return (
    <div className="mobile-cta-bar fixed inset-x-0 bottom-[var(--cookie-h,0px)] z-30 grid grid-cols-2 gap-2 border-t border-gold/20 bg-obsidian/95 p-2 backdrop-blur md:hidden">
      <a
        href={PHONE_HREF}
